-- MySQL dump 10.16  Distrib 10.1-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: mydb
-- ------------------------------------------------------
-- Server version	10.1-MariaDB-10.1+maria~jessie
...
CREATE TABLE dockerSample (
  nombre varchar(20) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1;
